...
typedef enum {PARAM,SALIR, ERR_OPC_PPAL, INICIO, ERR_OPC_FUN, ERR_DAT, FUNC} t_stat; /*Cambie el orden de param y salir porque asi es como se pide cuando hace el printf (param=0)*/
...
/*Esto deberia ser una funcion :/ */				cant_muestras=(int)men_par(param, camb);
								...
								if(tiempoi>tiempof){ /*tenia el signo puesto al revez*/
