...
t_stat funciones (float tiempoi, float tiempof, int cant_muestras, t_funciones funcion, int prec){
	...
	switch (funcion){
			...
			case F_LOG:
							...
							f_logaritmica(tiempoi, tiempof, prec, cant_muestras);
							break;

			case F_LOGLINEAL:

							f_loglineal(tiempoi, tiempof, prec, cant_muestras);
							break;

			case F_EXPONENCIAL:

							f_exponencial(tiempoi, tiempof, prec, cant_muestras);
							break;
			...
			case F_PAR_HIP:
							...
							f_paraboloide_hiperbolico(tiempoi, tiempof, prec, cant_muestras);
